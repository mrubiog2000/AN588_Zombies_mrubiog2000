...
mean(height) #Another way to do it If wanted to see the mean from a specific column (variable).
...
#No sé si vale porque quizá la media cambia cada vez que haes "mean()".
